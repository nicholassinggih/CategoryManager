(function (root, factory) {
    ...
    BackTree.Item = (function (superClass) {
        ...
        Item.prototype.onChildrenChanged = function () {
            if (this.onChildrenChangedHandler) {
                this.onChildrenChangedHandler(this);
            }
            this.resetClassNames();
            return this.setupClassNames();
        };
        ...
        Item.prototype.onCheckboxClicked = function (e) {
            ...
            return this.model.set('checked', $checkbox.prop('checked'));
    ...
    BackTree.plugins.DnD = (function (superClass) {
        ...
        DnD.prototype.saveModelPosition = function () {
            ...
            if (result) {
                return this.collection.trigger('dndStructureChanged', this.view.model, result.oldPosition, result.newPosition);
            }
        };
